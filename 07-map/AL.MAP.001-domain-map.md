...
| Исследовать коллективный переход к новой системе деятельности | AL.SOTA.026 (`source-harvesting`) | STH.EXL.001–023 → будущие STH.EXL.CLAIM.*; решение о новом паттерне отложено до рассмотрения утверждений |
