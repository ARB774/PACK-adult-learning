...
Файл содержит только отношения и записи, для которых существует конкретная задача сопровождения пилотной редакции `DPF-EDITION@pilot-2026-08-18.2`.
...
`DPF-EDITION@pilot-2026-08-18.2` использует правила авторинга, видов, отношений, качества и пакетной оценки из FPF Левенчука в коммите `3d098629dc218572089f1890080c17d6f1d9a867` как необходимые ограничения для пилотного DPF-авторинга и проверки.
...
```yaml
FrameworkEditionDependencyRecord@DPF-EDITION-pilot-2026-08-18.2:
  ...
  dependentEditionRef: DPF-EDITION@pilot-2026-08-18.2
...
`AL.P.001`, `AL.P.002` и `AL.P.003` являются соседними самостоятельными паттернами одного пилотного выбранного набора. Обязательный общий порядок между ними не установлен.
...
`DPF-EDITION@pilot-2026-08-18` и `DPF-EDITION@pilot-2026-08-18.2` являются разными точными эпистемами: во второй выбранный набор добавлен `AL.P.003`. Положительное `EpistemeEditionRelation` между ними пока не заявляется, потому что отдельное основание исторической непрерывности и требуемые FPF факты ревизионной работы не установлены.
...
```yaml
FrameworkPackageManifest@DPF-EDITION-pilot-2026-08-18.2:
  frameworkEditionRef: DPF-EDITION@pilot-2026-08-18.2
